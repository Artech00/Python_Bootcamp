...
# ===============================
# Lesson 7: Intro to Strings
# ===============================
# String - ը char-երի դասավորված հաջորդականությունա (ordered sequence)
# Կարող ենք գրել string-երը "" կամ '' մեջ (double quotes կամ single quotes)
intention = "I'm going\n to run"  # \n adds a new line
print(intention)
...
# ===============================
# Lesson 12: String Properties and Methods
# ===============================

# String-երը Python-ում ԱՆՓՈՓՈԽ են (IMMUTABLE).
# Սա նշանակում է, որ string-ի մեջ առժեք(value) չենք կարա փոխենք
...
# Եթե width չի նշված, default-ով
# ցույց կտա այնքան նիշ, որքան պետք է։
print(f"Result: {result:.3f}")  # 3 նիշ կետից հետո (precision=3), no width set

# Եթե width նշում ենք (օր․ -> 10), Python-ը "տեղ" է բացում,
# որպեսզի ընդհանուր output-ը լինի նվազագույնը 10 նիշ երկարությամբ։
...
# === Simple list ===
list1 = [1, 2, 3]
print(list1[0])  # առաջին տարրը (index 0)
...
# === Remove last element ===
new_list.pop()  # հեռացնում ենք վերջի արժեքը
print(new_list)
